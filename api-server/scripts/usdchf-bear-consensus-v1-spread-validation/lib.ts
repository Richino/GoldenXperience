// Shared helpers for the USDCHF Bear Consensus Structure V1 spread validation.
...
export const SOURCE_CSV =
  'C:/Users/arche/Downloads/GX_USDCHF_Bear_Consensus_Structure_V1_-_1_to_2_RR_OANDA_USDCHF_2026-09-05_6e176.csv';

export const INSTRUMENT = 'USD_CHF';
export const ORIGIN_HOUR_UTC = 11; // completed 11:00 UTC H1 candle (bar-open time)
export const AUTHORITATIVE_TRADE_COUNT = 103;
...
export interface TvTrade {
  ...
  resolvedEntryUtcMs: number; // UTC ms of the H1 signal bar (open time, must be 11:00)
  tvExitWallNy: string;
  resolvedExitUtcMs: number; // UTC ms of the exit bar (open time)
  tvEntryPrice: number; // TV mid close of the 11:00-open bar
  tvExitPrice: number;
  tvSignal: string; // USDCHF_1100_SHORT
...
export const PIP = 10000; // USDCHF quoted to 5 dp, 1 pip = 0.0001
