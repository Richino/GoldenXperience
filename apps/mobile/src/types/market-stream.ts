/** Vendored from `frontend/src/types/market-stream.ts` — the WS wire format. */
import type { MajorInstrument } from "@/types/forex";

export type MarketDataSource = "oanda" | "mock";
export type MarketStreamState = "idle" | "connecting" | "connected" | "mock" | "error" | "closed";
...
export type MarketStreamMessage = MarketPriceTick | MarketStreamStatus | MarketStreamHeartbeat;
