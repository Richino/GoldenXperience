import { DashboardView, type DashboardOverview, type DashboardStrategyRow, type DashboardWatchRow } from "@/components/dashboard/dashboard-view";
...
export default async function DashboardPage() {
  const [account, accountHistory, watchlist, strategyWatchlist, overview] = await Promise.all([
