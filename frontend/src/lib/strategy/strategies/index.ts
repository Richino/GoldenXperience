...
export const PAIR_STRATEGY_REGISTRY = {
  ...
  [USDCAD_STRATEGY_SYMBOL]: { id: USDCAD_STRATEGY_ID, name: USDCAD_STRATEGY_NAME, version: USDCAD_STRATEGY_VERSION, timeframe: USDCAD_STRATEGY_TIMEFRAME, config: USDCAD_STRATEGY_CONFIG, evaluate: evaluateUsdcadStrategy, executionEnabled: false, adaptiveParametersMutable: false, requiresActivePositionState: true },
  [USDCHF_STRATEGY_SYMBOL]: { id: USDCHF_STRATEGY_ID, name: USDCHF_STRATEGY_NAME, version: USDCHF_STRATEGY_VERSION, timeframe: USDCHF_STRATEGY_TIMEFRAME, config: USDCHF_STRATEGY_CONFIG, evaluate: evaluateUsdchfStrategy, executionEnabled: false, adaptiveParametersMutable: false, requiresActivePositionState: true },
  [EURJPY_STRATEGY_SYMBOL]: { id: EURJPY_STRATEGY_ID, name: EURJPY_STRATEGY_NAME, version: EURJPY_STRATEGY_VERSION, timeframe: EURJPY_STRATEGY_TIMEFRAME, config: EURJPY_STRATEGY_CONFIG, evaluate: evaluateEurjpyStrategy, executionEnabled: false, adaptiveParametersMutable: false, requiresActivePositionState: true },
  [CADJPY_STRATEGY_SYMBOL]: { id: CADJPY_STRATEGY_ID, name: CADJPY_STRATEGY_NAME, version: CADJPY_STRATEGY_VERSION, timeframe: CADJPY_STRATEGY_TIMEFRAME, config: CADJPY_STRATEGY_CONFIG, evaluate: evaluateCadjpyStrategy, executionEnabled: false, adaptiveParametersMutable: false, requiresActivePositionState: true },
  [NZDJPY_STRATEGY_SYMBOL]: { id: NZDJPY_STRATEGY_ID, name: NZDJPY_STRATEGY_NAME, version: NZDJPY_STRATEGY_VERSION, timeframe: NZDJPY_STRATEGY_TIMEFRAME, config: NZDJPY_STRATEGY_CONFIG, evaluate: evaluateNzdjpyStrategy, executionEnabled: false, adaptiveParametersMutable: false, requiresActivePositionState: true },
  [AUDJPY_STRATEGY_SYMBOL]: { id: AUDJPY_STRATEGY_ID, name: AUDJPY_STRATEGY_NAME, version: AUDJPY_STRATEGY_VERSION, timeframe: AUDJPY_STRATEGY_TIMEFRAME, config: AUDJPY_STRATEGY_CONFIG, evaluate: evaluateAudjpyStrategy, executionEnabled: false, adaptiveParametersMutable: false, requiresActivePositionState: true },
  [EURAUD_STRATEGY_SYMBOL]: { id: EURAUD_STRATEGY_ID, name: EURAUD_STRATEGY_NAME, version: EURAUD_STRATEGY_VERSION, timeframe: EURAUD_STRATEGY_TIMEFRAME, config: EURAUD_STRATEGY_CONFIG, evaluate: evaluateEuraudStrategy, executionEnabled: false, adaptiveParametersMutable: false, requiresActivePositionState: true },
} as const;
