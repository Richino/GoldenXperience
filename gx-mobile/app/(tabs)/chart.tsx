...
export default function ChartScreen() {
  ...
  const compactPair = (value: string) => value.toLowerCase().replace(/[^a-z0-9]/g, '');
  const pairMatches = PAIRS.filter((option) => compactPair(option).includes(compactPair(pairQuery)));
