...
const styles = StyleSheet.create({
  ...
  list: { paddingHorizontal: 4, paddingBottom: 8, gap: 8 }, item: { flexDirection: 'row', gap: 10, padding: 14, borderRadius: 14, backgroundColor: theme.colors.surfaceRaised }, unread: { backgroundColor: theme.colors.primarySoft }, dot: { width: 7, height: 7, borderRadius: 4, marginTop: 6 }, itemBody: { flex: 1, minWidth: 0 }, itemTop: { flexDirection: 'row', alignItems: 'baseline', gap: 8 }, itemTitle: { flex: 1, fontSize: 13, fontFamily: theme.fonts.sansSemiBold, color: theme.colors.textPrimary }, time: { fontSize: 11, fontFamily: theme.fonts.sansMedium, color: theme.colors.textMuted }, message: { marginTop: 4, fontSize: 12, lineHeight: 17, fontFamily: theme.fonts.sans, color: theme.colors.textSecondary }, issue: { color: theme.colors.danger },
});
